...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT brotli::brotlienc #############
        ...
        set_property(TARGET brotli::brotlienc PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlienc_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlienc PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${brotli_brotli_brotlienc_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlienc PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${brotli_brotli_brotlienc_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlienc PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlienc_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlienc PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlienc_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT brotli::brotlidec #############
        ...
        set_property(TARGET brotli::brotlidec PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlidec_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlidec PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${brotli_brotli_brotlidec_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlidec PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${brotli_brotli_brotlidec_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlidec PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlidec_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlidec PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlidec_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT brotli::brotlicommon #############
        ...
        set_property(TARGET brotli::brotlicommon PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlicommon_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlicommon PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${brotli_brotli_brotlicommon_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlicommon PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${brotli_brotli_brotlicommon_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlicommon PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlicommon_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET brotli::brotlicommon PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${brotli_brotli_brotlicommon_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET brotli::brotli PROPERTY INTERFACE_LINK_LIBRARIES brotli::brotlienc APPEND)
    set_property(TARGET brotli::brotli PROPERTY INTERFACE_LINK_LIBRARIES brotli::brotlidec APPEND)
    set_property(TARGET brotli::brotli PROPERTY INTERFACE_LINK_LIBRARIES brotli::brotlicommon APPEND)
