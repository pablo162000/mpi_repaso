...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT Ogg::ogg #############
        ...
        set_property(TARGET Ogg::ogg PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${ogg_Ogg_ogg_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Ogg::ogg PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${ogg_Ogg_ogg_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Ogg::ogg PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${ogg_Ogg_ogg_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Ogg::ogg PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${ogg_Ogg_ogg_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Ogg::ogg PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${ogg_Ogg_ogg_COMPILE_OPTIONS_RELEASE}> APPEND)
