...
set_property(TARGET freetype_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:PNG::PNG;ZLIB::ZLIB;BZip2::BZip2;brotli::brotli>
             APPEND)
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET Freetype::Freetype
                 ...
                 $<$<CONFIG:Release>:${freetype_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${freetype_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${freetype_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${freetype_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${freetype_COMPILE_OPTIONS_RELEASE}> APPEND)
