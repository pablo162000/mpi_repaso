...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT FLAC::FLAC++ #############
        ...
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC++_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC++_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC++_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC++_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC++ PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC++_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT FLAC::FLAC #############
        ...
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET FLAC::FLAC PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${flac_FLAC_FLAC_COMPILE_OPTIONS_RELEASE}> APPEND)
